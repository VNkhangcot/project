...
export const mockProducts = [
  ...
  },
  {
    ...
    tags: ['kitchen', 'appliance', 'panasonic'],
    createdAt: '2024-01-01T00:00:00.000Z',
    updatedAt: '2024-01-01T00:00:00.000Z',
    // Additional properties for UI
...
export const mockUsers = [
  {
    ...
    role: {
      ...
      permissions: ['read', 'write', 'delete', 'manage_users', 'manage_roles', 'manage_enterprises', 'manage_business_types', 'manage_subscriptions', 'manage_notifications', 'view_analytics', 'export_data', 'system_settings', 'audit_logs', 'security_monitoring', 'server_monitoring'] as Permission[],
      isDefault: true,
      isActive: true,
  ...
  },
  {
    ...
    role: {
      ...
      permissions: ['read', 'write', 'manage_users', 'view_analytics', 'export_data'] as Permission[],
      isDefault: true,
      isActive: true,
      createdAt: '2023-01-01T00:00:00.000Z',
      updatedAt: '2023-01-01T00:00:00.000Z'
  ...
  'user@shop.com': {
    ...
    user: {
      ...
      role: {
        ...
        permissions: ['view_products', 'manage_cart', 'place_orders', 'write_reviews', 'manage_profile'] as Permission[],
        isDefault: false,
        isActive: true,
        createdAt: '2023-01-01T00:00:00.000Z',
        updatedAt: '2023-01-01T00:00:00.000Z'
